...
Start using the production Compose override:
...
Deployment presets are included for:
...
Replace all placeholder JWT secrets and configure the production database before deployment.
